...
void nx_gnuplot_set_terminal_svg(struct NXGNUPlot *gnuplot, int width, int height, const char* title, const char *filename);
void nx_gnuplot_set_terminal_pdf(struct NXGNUPlot *gnuplot, double width_in_cm, double height_in_cm, const char *filename);
void nx_gnuplot_set_terminal_eps(struct NXGNUPlot *gnuplot, double width_in_cm, double height_in_cm, const char *filename);
void nx_gnuplot_set_terminal_ascii(struct NXGNUPlot *gnuplot, int width,  int height, NXBool linefeed);
