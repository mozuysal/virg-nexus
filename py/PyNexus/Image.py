...
wrap.argtypes = [Ptr, _POINTER(_c_ubyte), _c_int, _c_int, _c_int, _c_int, _c_int]
wrap.restype = None
...
filter_buffer_alloc.restype = _POINTER(_c_ubyte)

smooth_si = _nexus.nx_image_smooth_si
smooth_si.argtypes = [Ptr, Ptr, _c_float, _c_float, _POINTER(_c_ubyte)]
smooth_si.restype = None

smooth_s = _nexus.nx_image_smooth_s
smooth_s.argtypes = [Ptr, Ptr, _c_float, _c_float, _POINTER(_c_ubyte)]
...
xload_pnm.argtypes = [Ptr, _c_char_p, _c_int]
